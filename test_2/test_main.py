...
def test_date_avaiables_cars_no_available_cars():
  response = client.get("/dateAvaiblesCars?date=2024-12-27")
...
def test_rent_car_ok():
  response_pre = client.get("/dateAvaiblesCars?date=2024-12-23")
  ...
  response_post = client.get("/dateAvaiblesCars?date=2024-12-23")
